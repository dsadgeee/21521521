script_key="IJSCzEpYWyNpTboezVbWqdutsYqiZuXl";
setfpscap(2)
...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = { "Spooky Egg", "Jungle Egg", "Anti Bee Egg","Bug Egg", "Fall Egg","Paradise Egg"},
