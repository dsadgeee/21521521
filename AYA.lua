...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = {"Sprout Egg" ,"Rare Egg", "Gourmet Egg", "Zen Egg", "Legendary Egg", "Anti Bee Egg", "Primal Egg", "Bug Egg", "Paradise Egg", "Mythical Egg", "Common Summer Egg", "Rare Summer Egg"},
