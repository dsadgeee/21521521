...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = {"Sprout Egg","Gourmet Egg", "Corrupted Zen Egg", "Rare Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Anti Bee Egg", "Bee Egg", "Night Egg", "Bug Egg", "Paradise Egg", "Mythical Egg" },
