...
getgenv().gagConfig = {
    ...
    BUY_EGGS = {"Mythical Egg", "Bug Egg", "Bee Egg", "Paradise Egg", ["Common Summer Egg"] = 20, ["Rare Summer Egg"] = 20, ["Uncommon Egg"] = 99, "Rare Egg" },
    PLANT_EGGS = { "Gourmet Egg", "Zen Egg", "Anti Bee Egg", "Primal Egg", "Bug Egg", "Paradise Egg", "Mythical Egg","Rare Egg", "Common Summer Egg", "Rare Summer Egg" },
    ...
    EQUIP_PETS = { ["Sunny-Side Chicken"] = 5, ["Seal"] = 3, ["Rooster"] = 5, ["Capybara"] = 1 },
