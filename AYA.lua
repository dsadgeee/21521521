	...
	Pets = {
		...
		["Upgrade Slot"] = {
			...
			["Equip When Done"] = {
				...
				["Rooster"] = { 8, 100, 2 },
				["Glimmering Sprite"] = { 8, 100, 3 },
				["Tarantula Hawk"] = { 1, 100, 4 }, -- 5 on the first mean equip only 5 | pet , 100 mean equip only level pet lower than 100 | the one on the last is priority it will ues first if possible 
				["Hotdog Daschund"] = { 4, 100, 5 },
				["Blood Kiwi"] = { 8, 100, 6 },
				["Starfish"] = { 1, 100, 7 },
			},
		},
